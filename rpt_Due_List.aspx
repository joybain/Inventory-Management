<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Due_List.aspx.cs" Inherits="rpt_Due_List" %>
...
<asp:GridView ID="dgLedger" runat="server" AutoGenerateColumns="False" CssClass="Grid"
  ...
  <asp:BoundField HeaderText="Account"  
      ...
      <asp:BoundField DataField="Period_amount" HeaderText="Dr Amount" >

      <ItemStyle HorizontalAlign="Right" Width="150px" />
      </asp:BoundField>

      <asp:BoundField HeaderText="Cr Amount" >
       <ItemStyle HorizontalAlign="Right" Width="150px" />
      </asp:BoundField>
...
<asp:LinkButton ID="lbExp" runat="server" Text="Export Report to PDF" 
        Font-Size="X-Small" ForeColor="Blue" Width="150px"></asp:LinkButton>
</td>
<td style="width:10%;">&nbsp;</td>
</tr>
</table>
