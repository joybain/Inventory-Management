<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContraVoucherUI.aspx.cs" Inherits="ContraVoucherUI" %>--%>
<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ContraVoucherUI.aspx.cs" Inherits="ContraVoucherUI" Title="Contra Voucher.-DDP"  Theme="Themes" MaintainScrollPositionOnPostback="true"%>
...
<tr>
<td style="width:1%;">&nbsp;</td>
    <td style="width: 98%; vertical-align: top; color: Maroon;"  align="left"><h2>>> Contra Voucher.</h2></td>
<td style="width:1%;">&nbsp;</td>
</tr>
<tr>
<td style="width:1%;"></td>
...
<ContentTemplate>--%>
   ...
   <ContentTemplate>
       <fieldset style="vertical-align: top; border: solid 1px #8BB381; text-align:left;"><legend style="color: maroon;"><b>Voucher Information </b></legend>
       ...
       <tr>
            <td align="left" colspan="9">
                ...
                <ajaxToolkit:CalendarExtender ID="txtMoneyRptDate_CalendarExtender" runat="server" Format="dd/MM/yyyy" TargetControlID="txtMoneyRptDate" />
                ...
                <asp:Label ID="Label1" runat="server" Font-Size="8pt" Visible="False" style="display:none;" >Volume No</asp:Label>
                ...
                <asp:Label ID="lblCheckNo" runat="server" Font-Size="8pt" style="display:none;">Cheque No</asp:Label>
                <asp:TextBox ID="txtCheckNo" runat="server" AutoPostBack="True" style="display:none;"></asp:TextBox>
                <asp:Label ID="lblCheqDate" runat="server" Font-Size="8pt" style="display:none;">Cheque Date</asp:Label>
                <asp:TextBox ID="txtCheqDate" runat="server" AutoPostBack="False" CssClass="tbc" Font-Size="8pt" MaxLength="11" SkinID="tbGray" style="display:none;"></asp:TextBox>
                <ajaxToolkit:CalendarExtender ID="txtCheqDate_CalendarExtender" runat="server" Format="dd/MM/yyyy" TargetControlID="txtCheqDate" />
                <asp:Label ID="lblCheqAmnt" runat="server" Font-Size="8pt" style="display:none;">Cheque Amount</asp:Label>
                <asp:TextBox ID="txtCheqAmnt" runat="server" AutoPostBack="False" CssClass="tbc" Enabled="False" Font-Size="8pt" MaxLength="15" SkinID="tbGray" style="display:none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 15%;">
                <asp:TextBox ID="txtVchSysNo" runat="server" AutoPostBack="False" 
                    CssClass="tbc" Font-Size="8pt" MaxLength="6" SkinID="tbGray" Width="100%" 
                    Visible="False" Enabled="False"></asp:TextBox>
                <asp:TextBox ID="txtVchSysNo0" runat="server" AutoPostBack="False" 
                    CssClass="tbc" Font-Size="8pt" MaxLength="6" SkinID="tbGray" Width="100%"></asp:TextBox>
            </td>
            <td style="width: 5%;" align="left" />
            <td align="left" style="width: 15%;">
                <asp:Label ID="LblValueDate" runat="server" Font-Size="8pt" Width="100%" 
                    style="font-weight: 700">Voucher 
                Date</asp:Label>
            </td>
            <td style="width: 15%;">
            ...
            <td style="width: 5%;" align="left" />
            <td align="left" style="width: 15%;">
                <asp:Label ID="lblForStatus" runat="server" Font-Size="8pt" Width="100%" 
                    style="font-weight: 700">Total 
                Cash in Hand :</asp:Label>
            </td>
            <td align="right" colspan="2">
                <asp:Label ID="lblAmountStatus" runat="server" Font-Bold="True" 
                    Font-Size="Small" ForeColor="#FF3300" Text="0.00"></asp:Label>
            </td>
        </tr>

        <tr>
            <td align="left" style="width: 15%;">
                <asp:Label ID="LblVchRefNo" runat="server" Font-Size="8pt" Width="100%">Reference 
                No</asp:Label>
            </td>
            <td style="width: 15%;">
                <asp:TextBox ID="txtVchRefNo" runat="server" AutoPostBack="False" 
                    CssClass="tbc" Font-Size="8pt" MaxLength="30" SkinID="tbGray" Width="100%"></asp:TextBox>
            </td>
            <td style="width: 5%;" align="left" />
            &nbsp;<td align="left" style="width: 15%;">
                <asp:Label ID="Label6" runat="server" Font-Size="8pt" Width="100%">Manual 
            ...
            <td style="width: 5%;" align="left" />
            &nbsp;<td align="left" style="width: 15%;">
                <asp:Label ID="lblBankStatus" runat="server" Font-Size="8pt" 
                    style="font-weight: 700">Total Cash at Bank :</asp:Label>
            </td>
            <td align="right" colspan="2">
        ...
        <tr>
            ...
            <td style="width: 15%;" align="left">
                <asp:TextBox ID="txtAmt" runat="server" AutoPostBack="False" CssClass="tbc" 
                    Font-Size="8pt" MaxLength="30" SkinID="tbGray" Visible="False" Width="100%">0</asp:TextBox>
            </td>
            <td style="width: 15%;">
                &nbsp;</td>
            <td style="width: 5%;" align="left" />
            <asp:Label ID="lblStatus0" runat="server" Font-Size="8pt" Width="100%" 
                style="font-weight: 700">Status</asp:Label>
            <td style="width: 15%;" align="left">
                    ...
                    <asp:GridView ID="dgVoucherDtl" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="COA Description">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtCoaDesc" runat="server" autocomplete="off" onFocus="this.select()" placeHolder="Search chart-of-accounts.."
...
<ajaxtoolkit:TabPanel ID="tpVchHist" runat="server" HeaderText="Voucher History">
    <ContentTemplate>
           ...
           <table style="width: 100%">
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 40%; font-weight: 700;">
                                    <asp:Label ID="Label14" runat="server" Text="Search Voucher NO :"></asp:Label>
                                </td>
                                <td style="width: 60%">
                                    <asp:TextBox ID="txtVoucher" runat="server" Height="20px" CssClass="txtVisibleAlign"
                                        Placeholder="Input Voucher No and click Find Button" Width="100%"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
            ...
            onselectedindexchanged="dgVoucher_SelectedIndexChanged" Width="100%" 
            PageSize="50">
            <HeaderStyle 
                BackColor="Silver" Font-Bold="True" Font-Names="Arial" Font-Size="8pt" 
                ForeColor="Black" HorizontalAlign="Center" /><Columns>
                <asp:CommandField 
                    ShowSelectButton="True" >
                    <ItemStyle HorizontalAlign="Center" Width="55px" Font-Bold="True" Font-Size="10pt" />
                </asp:CommandField>
                    <asp:BoundField DataField="vch_sys_no" 
                    ...
                    <asp:BoundField DataField="value_date" 
                    DataFormatString="{0:dd/MM/yyyy}" HeaderText="Voucher Date" >
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                </asp:BoundField>
                    <asp:BoundField 
                    DataField="particulars" HeaderText="Particulars">
