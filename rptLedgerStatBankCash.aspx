<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLedgerStatBankCash.aspx.cs" Inherits="rptLedgerStatBankCash" %>
    ...
    <table class="style1">
        <tr>
            <td style="width:50%;">
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:15%;">Search By COA Code</td>
                        <td style="width:2%; text-align: center">
                            : </td>
                        <td style="width:50%;">
                            <asp:TextBox ID="txtSearchCoa" runat="server" AutoPostBack="True" 
                                CssClass="txtVisibleAlign" Height="18px"
                    onfocus="this.select();" 
                    placeholder="Search By Items." TabIndex="1" Width="99%" 
                                ontextchanged="txtSearchCoa_TextChanged"></asp:TextBox>
                <cc:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" 
                    ...
                    MinimumPrefixLength="1" ServiceMethod="GetSearchBankCashCoa" 
                    ServicePath="AutoComplete.asmx" TargetControlID="txtSearchCoa" />
                        </td>
                    </tr>
                </table>
                </fieldset>
            ...
            <td style="width:30%;">
                <table style="width:100%;border: solid 1px #8BB381;">
                    <tr>
...
<asp:GridView ID="dgLedger" runat="server" AutoGenerateColumns="False" style="text-align:center;" 
  ...
  <asp:BoundField HeaderText="M.V.NO" ItemStyle-Width="40px" 
  ...
  <asp:BoundField HeaderText="Debit" ItemStyle-Width="250px" 
          DataField="Debit_amt"  ItemStyle-HorizontalAlign="Left" 
          DataFormatString="{0:N3}" > 
<ItemStyle HorizontalAlign="Right" Width="110px"></ItemStyle>
      </asp:BoundField>
      <asp:BoundField HeaderText="Credit" ItemStyle-Width="150px" 
          DataField="Credit_amt"  ItemStyle-HorizontalAlign="Left" 
          DataFormatString="{0:N3}" > 
<ItemStyle HorizontalAlign="Right" Width="110px"></ItemStyle>
      </asp:BoundField>
  </Columns>
