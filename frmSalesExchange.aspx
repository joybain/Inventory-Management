<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmSalesExchange.aspx.cs" Inherits="frmSalesExchange" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 2%">
                            &nbsp;</td>
                        <td style="width: 51%">
                            <asp:TextBox ID="txtSearchInvoice" runat="server" Width="100%" 
                                ontextchanged="txtSearchInvoice_TextChanged"></asp:TextBox>
