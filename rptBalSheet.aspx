<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBalSheet.aspx.cs" Inherits="rptBalSheet" %>
...
<td style="width:20%;">
    <asp:HiddenField ID="hfRepType" runat="server" />
    </td>
</tr>
<tr>
<td style="width:20%;"></td>
...
<tr>
<td >
<asp:GridView ID="dgBal" runat="server" AutoGenerateColumns="false" Visible="false" CssClass="Grid" 
        AllowPaging="False" Width="100%" BorderWidth="1px" BorderStyle="Solid"
        CellPadding="2" CellSpacing="0"  Font-Size="8pt"
        Font-Names="Verdana" onrowdatabound="dgBal_RowDataBound">
  <Columns> 
  <asp:BoundField ShowHeader="false" ItemStyle-Width="100px" DataField="gl_seg_code"  ItemStyle-HorizontalAlign="Center" ItemStyle-Height="15px"/>  
  <asp:BoundField ShowHeader="false" ItemStyle-Width="200px" DataField="coa_desc"  ItemStyle-HorizontalAlign="Left" /> 
  <asp:BoundField ShowHeader="false" ItemStyle-Width="30px" DataField="notes"  ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" /> 
  <asp:BoundField ShowHeader="false" ItemStyle-Width="120px" DataField="amount_a" DataFormatString="{0:N3}" ItemStyle-HorizontalAlign="Right"/>  
  <asp:BoundField ShowHeader="false" ItemStyle-Width="120px" DataField="amount_b" DataFormatString="{0:N3}" ItemStyle-HorizontalAlign="Right" />   
  </Columns>
...
<asp:GridView ID="dgBalNotes" runat="server" AutoGenerateColumns="False" 
        Visible="False" CssClass="Grid" Width="100%" BorderWidth="1px" BorderStyle="Solid" 
        CellPadding="2" BorderColor="Black" Font-Size="8pt" 
        Font-Names="Verdana" onrowdatabound="dgBalNotes_RowDataBound" 
        onrowcommand="dgBalNotes_RowCommand">
  <Columns>
  <asp:BoundField ShowHeader="false" ItemStyle-Width="50px" DataField="notes"  
...
<ItemStyle HorizontalAlign="Center" Height="15px" Width="50px"></ItemStyle>
  ...
  <asp:BoundField ShowHeader="false" ItemStyle-Width="50px" DataField="gl_seg_code"  
          ItemStyle-HorizontalAlign="Center" ItemStyle-Height="15px" 
          HeaderText="Code">  
<ItemStyle HorizontalAlign="Center" Height="15px" Width="50px"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField ShowHeader="false" ItemStyle-Width="350px" DataField="coa_desc"  
          ItemStyle-HorizontalAlign="Left" HeaderText="Particulars" > 
<ItemStyle HorizontalAlign="Left" Width="350px"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField ShowHeader="false" ItemStyle-Width="50px" DataField="parent_notes"  
          ItemStyle-HorizontalAlign="Center" ItemStyle-Height="15px">
<ItemStyle HorizontalAlign="Center" Height="15px" Width="50px"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField ShowHeader="false" ItemStyle-Width="120px" DataField="amount_a" 
...
<ItemStyle HorizontalAlign="Right" Width="120px"></ItemStyle>
  ...
  <asp:BoundField ShowHeader="false" ItemStyle-Width="120px" DataField="amount_b" 
          DataFormatString="{0:N3}" ItemStyle-HorizontalAlign="Right" 
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 2%;" align="center">
                                            :</td>
                                        <td colspan="4">
                                            <asp:Label ID="lblCoaCode" runat="server" style="font-weight: 700"></asp:Label>
                                            -<asp:Label ID="lblCoaName" runat="server" style="font-weight: 700"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 20%;">
                                            <asp:TextBox ID="txtStartDt" runat="server" Font-Size="8pt" PlaceHolder="dd/MM/yyyy"
                                                SkinID="tbPlain" Width="80%" Font-Bold="True" Height="20px"></asp:TextBox>
...
<asp:LinkButton ID="lbExp" runat="server" Text="Export Report to PDF" 
        Font-Size="12pt" ForeColor="Blue" onclick="lbExp_Click" 
        Font-Bold="True"></asp:LinkButton>
</td>
<td style="width:50%; vertical-align:top;" align="right">       
<asp:LinkButton ID="lbExp1" runat="server" Text="Export Report With Notes to PDF" 
        Font-Size="12pt" ForeColor="Blue" onclick="lbExp1_Click" Font-Bold="True"></asp:LinkButton>        
</td>
</tr>
...
<asp:LinkButton ID="lbExpExcel" runat="server" Text="Export Report to Excel" 
        Font-Size="12pt" ForeColor="Blue" onclick="lbExpExcel_Click" 
        Font-Bold="True"></asp:LinkButton>
</td>
<td style="width:50%; vertical-align:top;" align="right">       
<asp:LinkButton ID="lbExpNodeExcel" runat="server" Text="Export Report With Notes to Excel" 
        Font-Size="12pt" ForeColor="Blue" onclick="lbExpNodeExcel_Click" 
        Font-Bold="True"></asp:LinkButton>        
</td>
</tr>
