<%@ Page Title="" Language="C#" MasterPageFile="~/BranchMasterPage.master" AutoEventWireup="true" CodeFile="BranchSalesVoucher.aspx.cs" Inherits="BranchSalesVoucher" %>
            ...
            <td style="width: 25%" align="left" valign="top">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 60%; height: 23px;">
                                                         <asp:TextBox ID="txtVat" runat="server" AutoPostBack="True" 
                                                             onfocus="this.select();" onkeypress="return isNumber(event)"  ontextchanged="txtVat_TextChanged" 
                    ...
                    <tr>
                        ...
                        <td style="width: 60%; height: 23px;">
                            <asp:TextBox ID="txtDiscount" runat="server" AutoPostBack="True" 
                                onfocus="this.select();" onkeypress="return isNumber(event)"  ontextchanged="TotalDiscount_TextChange" 
                    ...
                    <tr>
                        ...
                        <td style="width: 60%; height: 24px;">
                            <asp:TextBox ID="txtGrandTotal" runat="server" AutoPostBack="True" 
                                         onkeypress="return isNumber(event)"  Enabled="False" onfocus="this.select();" style="text-align:right;" TabIndex="6" 
                                Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 60%; height: 23px;">
                            <asp:TextBox ID="txtPayment" runat="server" AutoPostBack="True" onkeypress="return isNumber(event)" 
                            ...
                            <asp:TextBox ID="txtLastFigarAmount" runat="server" AutoPostBack="True" 
                                         onfocus="this.select();" 
                                         style="text-align:right;" TabIndex="7" Width="100%" Visible="False" 
                                         ></asp:TextBox>
