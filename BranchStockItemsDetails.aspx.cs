...
public partial class BranchStockItemsDetails : System.Web.UI.Page
{
    ...
    protected void txtName_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('This  Item not found..!!','teal',3);", true);
            return;
        }
    }
    protected void txtCatagory_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('This Category Item not found..!!','teal',3);", true);
            return;
        }
    }
    protected void txtSubCatagory_TextChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('This sub-category Item not found..!!','teal',3);", true);
            return;
        }
    }
    protected void txtBrand_TextChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('This Brand Item not found..!!','teal',3);", true);
            return;
        }
    }
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(txtFormDate.Text))
        {
            if (!string.IsNullOrEmpty(txtToDate.Text))
            {
                if (DataManager.DateEncode(txtFormDate.Text) > DataManager.DateEncode(txtToDate.Text))
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('From date not upper then to date.!!','teal',3);", true);
        ...
        dtItems = _aClsItemDetailsManager.getShowBranchItemsInfo(hfItemsID.Value, hfCatagoryID.Value,
            hfSubCatagoryID.Value, hfBrand.Value, ddlDepart.SelectedValue, txtFormDate.Text, txtToDate.Text, hfItemsIDOnly.Value, txtItemDesc.Text, Session["BranchId"].ToString());
    ...
    protected void txtItemDesc_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('Not Found Barcode.!!','teal',3);", true);
