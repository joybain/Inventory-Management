...
public partial class frmExpenses : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int count = IdManager.GetShowSingleValueInt("COUNT(*)", "ID", "ExpenseHead", txtColorID.Text);
        if (count > 0)
        {
        ...
        else
        {
            ...
            IdGlCoa = IdManager.getAutoIdWithParameter("602", "GL_SEG_COA", "SEG_COA_CODE",
    ...
    private void RefreshAll()
    {
        ...
        dgColor.DataSource = ExpenseHeadManager.GetColorDetails();
        dgColor.DataBind();
        txtColorName.Focus();
    }
