...
public partial class frmBranchDailyExpenses : System.Web.UI.Page
{
    ...
    private void RefreshAll()
    {
        ...
        txtCode.Text = "Exp-" + DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() +
                       ...
                       IdManager.GetShowSingleValueString("ExpensesID", "FixValue") + Session["BranchId"].ToString();
        txtDate.Text = DateTime.Now.ToString("dd/MM/yyyy");
        txtRemarks.Text = txtTotal.Text = string.Empty;
        txtRemarks.Text = "Daily Expenses for ";
        DataTable dtExpensesDetais = _aeExpenseHeadManager.GetShowwBranchAllExpenses(Session["BranchId"].ToString());
    ...
    protected void btnDownLode_Click(object sender, System.EventArgs e)
    {
        try
        {
