<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreditVoucherUI.aspx.cs" Inherits="CreditVoucherUI" %>--%>

  <%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CreditVoucherUI.aspx.cs" Inherits="CreditVoucherUI" Title="Credit Voucher.-DDP"  Theme="Themes" MaintainScrollPositionOnPostback="true"%>
...
<table  id="pageFooterWrapper">
  <tr>       
       ...
       <asp:Button ID="Delete" runat="server" ToolTip="Delete" onclick="Delete_Click"  
               ...
               Text="Delete" Height="35px" Width="60%" BorderStyle="Outset"  />
        </td>             
       ...
       <asp:Button ID="btnSave" runat="server" ToolTip="Save Voucher" onclientclick="javascript:return window.confirm('are u really want to save these data')"
        onclick="btnSave_Click" Text="Save"  Height="35px" Width="60%" 
               BorderStyle="Outset"  />
       </td>

        <td align="center" >
       <asp:Button ID="Clear" runat="server"  ToolTip="Clear" onclick="Clear_Click" 
                Text="Clear" Height="35px" Width="60%" BorderStyle="Outset"  />
       </td>

       <td align="center" style="cursor:hand;">
       <asp:Button ID="btnPrint" runat="server" ToolTip="Print"  onclick="btnPrint_Click" 
               Text="Print"  Height="35px" Width="60%" BorderStyle="Outset"  /> 
       </td>
  </tr>
   </table>
...
<tr>
<td style="width:1%;">&nbsp;</td>
    <td style="width: 98%; vertical-align: top; color: Maroon;"  align="left"><h2>>> Credit Or Received Voucher.</h2></td>
<td style="width:1%;">&nbsp;</td>
</tr>
<tr>
<td style="width:1%;"></td>
...
<ContentTemplate>--%>
   ...
   <ContentTemplate>
        ...
        <tr>
            <td align="left" colspan="9" style="height: 13px">
                ...
                <asp:DropDownList ID="ddlPayMode" runat="server" AutoPostBack="True" style="display:none;"
                    Font-Size="8pt" Height="18px" SkinID="ddlPlain" Width="95px">
                    <asp:ListItem></asp:ListItem>
        ...
        <tr>
            ...
            <td align="left" style="width: 15%;">
                <asp:Label ID="LblValueDate0" runat="server" Font-Size="8pt" Width="100%" 
            ...
            <td style="width: 5%;" align="left" />
            <td align="left" style="width: 15%;">
                <asp:Label ID="lblForStatus" runat="server" Font-Size="8pt" 
        ...
        <tr>
            ...
            <td style="width: 15%;" align="left">
                <asp:Label ID="lblBankStatus" runat="server" Font-Size="8pt" 
                    style="font-weight: 700">Total Cash at 
                Bank :</asp:Label>
            </td>
            <td align="right" colspan="2">
        ...
        <tr>
            ...
            <td colspan="7">
                <asp:TextBox SkinID="tbGray" ID="txtParticulars" runat="server" Width="100%" 
        ...
        <tr>
            ...
            <td style="width: 15%;">
                <asp:DropDownList ID="ddlBank" runat="server" AutoPostBack="True" 
                    Font-Size="8pt" Height="18px" SkinID="ddlPlain" 
                    Width="100%">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem Text="Cash" Value="C"></asp:ListItem>
                    <asp:ListItem Text="Cheque" Value="Q"></asp:ListItem>
            ...
            <asp:Label ID="lblColor" runat="server" Font-Bold="True" ForeColor="Red" 
                Text="*"></asp:Label>
            <td style="width: 15%;" align="left">
                <asp:Label ID="lblCheckNo" runat="server" Font-Size="8pt" Width="100%">Cheque 
                No</asp:Label>
            </td>
            <td style="width: 15%;">
                <asp:TextBox ID="txtCheckNo" runat="server" AutoPostBack="False" 
                    CssClass="tbc" Font-Size="8pt" MaxLength="25" SkinID="tbGray" Width="100%"></asp:TextBox>
            </td>
            <td style="width: 5%;" align="center" />
        ...
        <tr>
            ...
            <td style="width: 15%">
                <asp:TextBox ID="txtCheqAmnt" runat="server" AutoPostBack="False" 
                    CssClass="tbc" Font-Size="8pt" MaxLength="15" SkinID="tbGray" Width="100%"></asp:TextBox>
            </td>
            <td style="width: 5%;" align="center" />
            ...
            <td style="width: 15%;">
                &nbsp;</td>
            <td style="width: 5%;" align="left" />
            <asp:Label ID="lblStatus0" runat="server" Font-Size="8pt" 
            ...
            <td style="width: 15%;" align="left">
                ...
                <ajaxToolkit:ModalPopupExtender ID="lbAuth_ModalPopupExtender" runat="server" 
                    ...
                    <asp:GridView ID="dgVoucherDtl" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Credit">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtCredit" runat="server" AutoPostBack="true" CssClass="tbr" onkeypress="return isNumber(event)"
                                        MaxLength="25" ontextchanged="txtCredit_TextChanged" SkinID="tbGray"  onFocus="this.select()"
                            ...
                            <asp:TemplateField HeaderText="Debit">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtDebit" runat="server" AutoPostBack="true" CssClass="tbr" onkeypress="return isNumber(event)"
                                        MaxLength="25" ontextchanged="txtDebit_TextChanged" SkinID="tbGray"  onFocus="this.select()" 
                        ...
                        <tr>
                            <td colspan="4">
                                <fieldset style="vertical-align: top; border: solid 1px #8BB381; text-align:left;width: 50%">
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="width: 42%; font-weight: 700;">
                        ...
                        <tr>
                            <td colspan="4">
                                <asp:GridView ID="dgVoucher" runat="server" AllowPaging="True" 
                                    ...
                                    Caption="Voucher History" CellPadding="2" CssClass="mGrid" Font-Size="8pt" 
