<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmCustomerPayment.aspx.cs" Inherits="frmCustomerPayment" %>
    ...
    <table style="width: 100%;background-color: white">
        ...
        <tr>
            <td style="width: 20%">
                &nbsp;</td>
            <td style="width: 60%">
                <fieldset style="vertical-align: top; border: solid 1px #8BB381;text-align:left;"><legend style="color: maroon;"><b>Customer Payment</b> </legend>
                <table style="width: 100%">
                    <tr>
                        <td style="width: 17%; height: 32px;" align="right">
                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Search Customer"></asp:Label>
                        </td>
                        <td style="width: 2%; height: 32px;">
                            </td>
                        <td style="height: 32px;" colspan="4">
                            <asp:TextBox ID="txtSearchCustomer" runat="server" Width="98%" placeHolder="Search customer..!!"
                                AutoPostBack="True" ontextchanged="txtSearchCustomer_TextChanged" 
                                Height="18px"></asp:TextBox>
                            <asp:HiddenField ID="hfCustomer" runat="server" />
                            <asp:HiddenField ID="hfCustomerCoa" runat="server" />
                            <ajaxToolkit:AutoCompleteExtender ServicePath="AutoComplete.asmx" runat="server" 
                                                              ID="AutoCompleteExtender3" TargetControlID="txtSearchCustomer"
                    ...
                    <tr>
                        ...
                        <td style="width: 15%; height: 24px;">
                            <asp:TextBox ID="txtPayAmount" style="text-align: right" runat="server"   onkeypress="return isNumber(event)"
...
<ItemStyle HorizontalAlign="Left" Width="80px"></ItemStyle>
  ...
  <asp:BoundField  HeaderText="Customer Name"  DataField="ContactName" ItemStyle-Width="100px" 
          ItemStyle-HorizontalAlign="Left">    
