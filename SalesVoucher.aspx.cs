...
public partial class SalesVoucher : System.Web.UI.Page
{
        ...
        if (Session["user"] == null)
        {
            if (Session.SessionID != "" | Session.SessionID != null)
            {
                ...
                if (ses != null)
                {
                    ...
                    cmd.CommandText =
                        "Select BranchId,ID,user_grp,description from utl_userinfo where upper(user_name)=upper('" +
    ...
    {
        string Parameter = "";
        Parameter = " where UPPER([SearchName])='" + txtCustomerName.Text.ToUpper() + "' ";
    ...
    protected void txtCode_TextChanged(object sender, EventArgs e)
    {
        ...
        string branchId;
        if (ddlBranchId.SelectedValue == null)
        {
            branchId = null;
        }
        else
        {
            branchId = (ddlBranchId.SelectedValue).ToString();
        }
         

        DataTable dtItemsSearch = _aItemManager.GetSearchItemsOnStock1(txtItemsCode.Text.ToUpper(), splitCode.Length, branchId);
    ...
    //    txtGrandTotal.Text = (((subtotal - discount) + (subtotal * vat / 100))).ToString("N2");
    //    //  txtAmount.Text = (((subtotal - discount) + (subtotal * vat / 100))).ToString("N2");
    //    // txtPayment.Text = (((subtotal - discount) + (subtotal * vat / 100))).ToString("N2");

    //    txtDue.Text = (((subtotal - discount) + (subtotal * vat / 100)) - totalPayment).ToString("N1");

    //    txtLastFigarAmount.Text = txtGrandTotal.Text;
    //    PointCalculation();
    //    // UpItemsDetails.Update();
    //}
    ...
    protected void btnNew_Click(object sender, EventArgs e)
    {
        ...
        btnSave.Visible=ddlBranchId.Visible = true;
        lblAcountNo.Visible = ddlBankName.Visible =
            lblBankNameTo.Visible = lblAcountNo.Visible = ddlAccountNo.Visible = lblAccNoPint.Visible = lblRcbBankPoint.Visible = false;
        DataTable dtpaymentTypeReceived = IdManager.GetShowDataTable("Select Name,ID from PaymentMethod    order by id asc");
        //util.PopulationDropDownList(ddlPaymentTypeFrom, "Name", "ID", dtpaymentType);
    ...
    protected void btnFind_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Sales aSales = SalesManager.GetBranchShowSalesInfo(lblInvNo.Text, HidenBranchId.Value);
            if (aSales != null)
            {
                Clear();
                if (HidenBranchId.Value == "0")
                {
                    ddlBranchId.SelectedValue = "";
                }
                else
                {
                    ddlBranchId.SelectedValue = HidenBranchId.Value;
                }
                ...
                string Parameter = " where ID=" + hfCustomerID.Value + " and BranchId='" + HidenBranchId.Value + "'";
               ...
               // ddlDelevery.SelectedValue = aSales.DvStatus;
                ...
                DataTable DT1 = SalesManager.GetMainBranchSalesDetails(lblInvNo.Text, HidenBranchId.Value);
                if (DT1.Rows.Count > 0)
                {
                    dgSV.DataSource = DT1;
                    ViewState["SV"] = DT1;
                ...
                txtVat.Text = Convert.ToDouble(aSales.Tax).ToString("N0");
                ...
                VetAndDiscount();
                //txtAmount.Text = aSales.CReceive;
                decimal Refund =  Refund = Convert.ToDecimal(aSales.CRefund);
                ...
                if (aSales != null)
                {
                    if (per.AllowEdit == "Y")
                    {
                       ...
                       var RefundOrDue = Convert.ToDecimal(txtDue.Text);
                        ...
                        //var ExtraAmount = refund.ToString();
                        ...
                        aSales.BranchId = ddlBranchId.SelectedValue;
                        ...
                        //        "dbo.bank_branch", ddlAccountNo.SelectedValue);
                        //}
                        //else
                        //{
                        //    aSales.BankCoaCode = "";
                       ...
                       // aSales.PMethod = ddlPaymentTypeTo.SelectedValue;
                        ...
                        ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('Record(s) is/are Update suceessfullly!!','green',1);", true);
    ...
    protected void dgSVMst_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            lblInvNo.Text = dgSVMst.SelectedRow.Cells[6].Text.Trim();
            HidenBranchId.Value = dgSVMst.SelectedRow.Cells[7].Text.Trim();
            btnFind_Click(sender, e);
            btnNew.Visible = false;
            btnSave.Visible = true;
           // UpItemsDetails.Update();
        ...
        try
        {
            if (per.AllowDelete == "Y")
            {
                ...
                if (aSales != null)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "jsAlert('Record has been delete successfully...!!','green',1);", true);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
       ...
       // Document document = new Document(PageSize.A4, 25f, 25f, 25f, 30f);
       ...
       // float[] titwidth = new float[3] { 45, 14, 35 };
       ...
       // cell = new PdfPCell(new Phrase(dt2.Rows[0]["BOOK_DESC"].ToString(), FontFactory.GetFont(FontFactory.TIMES_ROMAN, 14, iTextSharp.text.Font.BOLD)));
       ...
       // var a = dt2.Rows[0]["COMPANY_ADDRESS1"].ToString() + "\n" + dt2.Rows[0]["COMPANY_ADDRESS2"].ToString();
       

       // //cell = new PdfPCell(new Phrase(dt2.Rows[0]["COMPANY_ADDRESS1"].ToString(), FontFactory.GetFont(FontFactory.TIMES_ROMAN, 9, iTextSharp.text.Font.BOLD)));
       // cell = new PdfPCell(new Phrase(dt2.Rows[0]["COMPANY_ADDRESS1"].ToString() + "\n" + dt2.Rows[0]["COMPANY_ADDRESS2"].ToString(), FontFactory.GetFont(FontFactory.TIMES_ROMAN, 9, iTextSharp.text.Font.BOLD)));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 1;
       ...
       // cell = new PdfPCell(new Phrase("INVOICE", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 14, iTextSharp.text.Font.BOLD)));
       ...
       // cell = new PdfPCell(new Phrase("", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 18, iTextSharp.text.Font.NORMAL)));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // cell.Rowspan = 1;
       // cell.Colspan = 1;
       ...
       // cell = new PdfPCell(new Phrase("Mobile : " + dt2.Rows[0]["Mobile"].ToString() , FontFactory.GetFont(FontFactory.TIMES_ROMAN, 9, iTextSharp.text.Font.BOLD)));
       // //cell = new PdfPCell(FormatPhrase(""));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.Colspan = 2;
       ...
       // cell = new PdfPCell(new Phrase("Printing Date : " + DateTime.Now.ToString(), FontFactory.GetFont(FontFactory.TIMES_ROMAN, 7, iTextSharp.text.Font.BOLD)));
       // //cell = new PdfPCell(FormatPhrase(""));
       ...
       // float[] titW = new float[4] { 14, 40, 16, 27 };
       // PdfPTable pdtm = new PdfPTable(titW);
       // pdtm.WidthPercentage = 100;

       // DataTable MSt = _aSalesManager.GEtSalesInvoiceMStDetails(txtInvoiceNo.Text, "");
       ...
       // cell = new PdfPCell(FormatHeaderPhrase(MSt.Rows[0]["InvoiceNo"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase("Customer Code :"));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);

       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["ManualCode"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["InvoiceDate"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["CustomerName"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase("MTC :"));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);

       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["emManualCode"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["customerAddress"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.Rowspan = 2;
       // cell.VerticalAlignment = 1;
       ...
       // cell = new PdfPCell(FormatHeaderPhrase("OTB :"));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);

       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["ServicesBy"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatPhrase8(MSt.Rows[0]["EMP_NO"].ToString()));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatPhrase8(""));
       // cell.BorderWidth = 0f;
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // pdtm.AddCell(cell);
       ...
       // float[] widthdtl = new float[10] { 5, 12, 13, 38, 10,12,13, 6, 10, 11 };
       // PdfPTable pdtdtl = new PdfPTable(widthdtl);
       // pdtdtl.WidthPercentage = 100;

       // cell = new PdfPCell(FormatHeaderPhrase8("SL#"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // //cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase8("P Code"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // // cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase8("CAT No."));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // // cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase8("Product Name"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       //// cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       //  cell = new PdfPCell(FormatHeaderPhrase8("Pack Size"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       //// cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatHeaderPhrase8("Batch/LOT"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // // cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase8("Exp.Date"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // // cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);
       ...
       // cell = new PdfPCell(FormatHeaderPhrase8("Qty"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       //// cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase8("Unit TP"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // //cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);

       // cell = new PdfPCell(FormatHeaderPhrase8("Net Price"));
       // cell.HorizontalAlignment = 1;
       // cell.VerticalAlignment = 1;
       // //cell.BorderWidth = 0f;
       // pdtdtl.AddCell(cell);
       ...
       // foreach (DataRow dr in MSt.Rows)
       // {
       //     sl++;
       //     cell = new PdfPCell(FormatPhrase8(sl.ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //    // cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["StyleNo"].ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //     // cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["CAT_No"].ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //     // cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["Name"].ToString()));
       //     cell.HorizontalAlignment = 0;
       //     cell.VerticalAlignment = 1;
       //    // cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["PackSize"].ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //     //cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["Lot"].ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //     //cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["ExpDate"].ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //     //cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(dr["Quantity"].ToString()));
       //     cell.HorizontalAlignment = 1;
       //     cell.VerticalAlignment = 1;
       //    // cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(DataManager.GetNumberBanglaFormat(dr["SalePrice"].ToString())));
       //     cell.HorizontalAlignment = 2;
       //     cell.VerticalAlignment = 1;
       //    // cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);

       //     cell = new PdfPCell(FormatPhrase8(DataManager.GetNumberBanglaFormat(dr["Total"].ToString())));
       //     cell.HorizontalAlignment = 2;
       //     cell.VerticalAlignment = 1;
       //     //cell.BorderWidth = 0f;
       //     pdtdtl.AddCell(cell);
       ...
       //     TotalAmount += Convert.ToDecimal(dr["Total"].ToString());
       ...
       // widthdtl = new float[8] { 6, 30, 12, 12, 11, 10, 12, 15 };
       // pdtdtl = new PdfPTable(widthdtl);
       // pdtdtl.WidthPercentage = 100;
       ...
       // cell.Colspan = widthdtl.Length;
       // pdtdtl.AddCell(cell);
       // int totlaman = Convert.ToInt32(Convert.ToDouble(MSt.Rows[0]["GrandTotal"].ToString()));
       // string amountInWord = "Taka " + Global.ConvertNumberToWords(totlaman) + " only.";


       // cell = new PdfPCell(FormatHeaderPhrase9("In Word : " + amountInWord));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 8;
       ...
       // cell = new PdfPCell(FormatPhrase8("Total TP : "));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 2;
       ...
       // cell = new PdfPCell(FormatPhrase8(DataManager.GetNumberBanglaFormat(MSt.Rows[0]["SubTotal"].ToString())));
       // cell.HorizontalAlignment = 2;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 1f;
       ...
       // cell = new PdfPCell(FormatPhrase8("Less Discount TP : "));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 2;
       ...
       // cell = new PdfPCell(FormatPhrase8(DataManager.GetNumberBanglaFormat(MSt.Rows[0]["DiscountAmount"].ToString())));
       // cell.HorizontalAlignment = 2;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 1f;
       // cell.BorderColor = BaseColor.BLACK;
       ...
       // if (MSt.Rows[0]["TaxAmount"].ToString() != "" && Convert.ToDecimal(MSt.Rows[0]["TaxAmount"].ToString()) != 0)
       // {
       //     cell = new PdfPCell(FormatPhrase8(""));
       //     cell.HorizontalAlignment = 0;
       //     cell.VerticalAlignment = 1;
       ...
       //     cell = new PdfPCell(FormatPhrase8("Vat TP : "));
       //     cell.HorizontalAlignment = 0;
       //     cell.VerticalAlignment = 1;
       //     cell.BorderWidth = 0f;
       //     cell.Colspan = 2;
       //     pdtdtl.AddCell(cell);
       //     decimal vatamount = ((Convert.ToDecimal(MSt.Rows[0]["SubTotal"].ToString()) - Convert.ToDecimal(MSt.Rows[0]["DiscountAmount"].ToString())) * Convert.ToDecimal(MSt.Rows[0]["TaxAmount"].ToString()) / 100);
       //     cell = new PdfPCell(FormatPhrase8(DataManager.GetNumberBanglaFormat(vatamount.ToString("N2"))));
       //     cell.HorizontalAlignment = 2;
       //     cell.VerticalAlignment = 1;
       //     cell.BorderWidth = 1f;
       //     cell.BorderColor = BaseColor.BLACK;
       ...
       // cell = new PdfPCell(FormatHeaderPhrase8NU("Net Payable : "));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 2;
       ...
       // cell = new PdfPCell(FormatHeaderPhrase8NU(DataManager.GetNumberBanglaFormat(MSt.Rows[0]["GrandTotal"].ToString())));
       // cell.HorizontalAlignment = 2;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 1f;
       // cell.BorderColor = BaseColor.BLACK;
       ...
       // widthdtl = new float[3] { 10, 45, 40 };
       // pdtdtl = new PdfPTable(widthdtl);
       // pdtdtl.WidthPercentage = 100;

       // cell = new PdfPCell(FormatHeaderPhrase8(""));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 4;
       ...
       // cell = new PdfPCell(FormatHeaderPhrase8NU("Note : "));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 1;
       ...
       // cell = new PdfPCell(FormatPhrase("Goods once sold will not be taken back."));
       // cell.HorizontalAlignment = 0;
       // cell.VerticalAlignment = 1;
       // cell.BorderWidth = 0f;
       // cell.Colspan = 1;
       ...
       // //document.Add(line2);
       //// cell = SignatureFormat(document, cell, txtLocalCustomer, dt2.Rows[0]["BOOK_DESC"].ToString());
    ...
    private static Phrase FormatHeaderPhrase8(string value)
    {
        return new Phrase(value, FontFactory.GetFont(FontFactory.TIMES_ROMAN, 9, iTextSharp.text.Font.BOLD));
    }
    private static Phrase FormatHeaderPhrase8NU(string value)
    {
    ...
    protected void ddlBankNameFrom_SelectedIndexChanged(object sender, EventArgs e)
    {
        
    }
    protected void ddlBranchId_SelectedIndexChanged(object sender, EventArgs e)
    {
        var branchId = ddlBranchId.SelectedValue;      
        Session["branchId"] = ddlBranchId.SelectedValue;
    }
    private void DropDownBrance()
    {
