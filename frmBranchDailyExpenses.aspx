<%@ Page Title="" Language="C#" MasterPageFile="~/BranchMasterPage.master" AutoEventWireup="true" CodeFile="frmBranchDailyExpenses.aspx.cs" Inherits="frmBranchDailyExpenses" %>
...
<div id="frmMainDiv" style="background-color:White; width:100%;">
    <table id="pageFooterWrapper">
        <tr>
            ...
            <td align="center" style="vertical-align:middle; height:100%;">
                <asp:Button ID="btnDownLode" runat="server" CssClass="buttonclass" 
                            onclick="btnDownLode_Click" Text="Downlode" Width="100px" 
                            Height="35px"  />
            </td>
            <td align="center" style="vertical-align:middle; height:100%;">
...
<asp:TemplateField HeaderText="Amount"><ItemTemplate>
                <asp:TextBox ID="txtItemRate" runat="server" Height="18px" AutoPostBack="True" 
                        CssClass="tbr" placeHolder="0.00" autocomplete="off" onkeypress="return isNumber(event)"
