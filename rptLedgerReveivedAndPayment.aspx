<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLedgerReveivedAndPayment.aspx.cs" Inherits="rptLedgerReveivedAndPayment" %>
...
.mGrid .alt { background: #fcfcfc url('css/black/img/grd_alt.png') repeat-x 50% top;
    ...
    <title>SDL.-Receipts & Payments Nots.</title>
...
<asp:GridView ID="dgLedger" runat="server" AutoGenerateColumns="False" style="text-align:center;" 
        AllowPaging="True" PageSize="100" Width="70%" BorderWidth="1px" BorderStyle="Solid"
  ...
  <Columns> 
      ...
      <asp:BoundField DataField="VALUE_DATE" HeaderText="Voucher Date">
            <ItemStyle HorizontalAlign="Center"  Width="10%"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField HeaderText="COA Code" ItemStyle-Width="40px" 
          ItemStyle-HorizontalAlign="Center" ItemStyle-Height="15px" 
          DataField="COA_NATURAL_CODE">  
                <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
      </asp:BoundField>
      <asp:BoundField DataField="SEG_COA_DESC" HeaderText="COA Description">
       <ItemStyle HorizontalAlign="Left" Height="15px" Width="30%"></ItemStyle>
      </asp:BoundField>
      <asp:BoundField DataField="amount_dr" HeaderText="Amount" 
