<%@ Page Language="C#" AutoEventWireup="true" CodeFile="New_rptDayBook.aspx.cs" Inherits="rptDayBook" %>
...
<ItemStyle HorizontalAlign="Center" Height="15px" Width="80px"></ItemStyle>
  ...
  <asp:BoundField HeaderText="Particulars" ItemStyle-Width="400px" 
          DataField="particulars"  ItemStyle-HorizontalAlign="Left" > 
<ItemStyle HorizontalAlign="Left" Width="400px"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField HeaderText="Vch Ref No" ItemStyle-Width="120px" 
          DataField="vch_manual_no"  ItemStyle-HorizontalAlign="Left" Visible="false"> 
<ItemStyle HorizontalAlign="Left" Width="120px"></ItemStyle>
      </asp:BoundField>
      <asp:BoundField DataField="VCH_CODE" HeaderText="VouchType" />
  <asp:BoundField HeaderText="Voucher#" ItemStyle-Width="100px" 
