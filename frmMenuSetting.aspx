<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmMenuSetting.aspx.cs" Inherits="frmMenuSetting" %>
                             ...
                             <td style="width: 20%; height: 68px"></td>
                              <td style="width: 60%; height: 68px">
                               ...
                               <table style="width: 100%">
                                    <tr>
                                        <td style="width: 100%">
                                            <asp:GridView ID="gdvMenu" runat="server" AllowPaging="True" 
