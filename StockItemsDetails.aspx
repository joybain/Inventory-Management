<%@ Page Title="Items Stock.-RD" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StockItemsDetails.aspx.cs" Inherits="StockItemsDetails" %>
...
<div id="frmMainDiv" style="background-color:White; width:100%;">  
    ...
    border-radius: 4px;box-sizing: border-box;background:transparent !important;"
                    ...
                    <tr>
                        <td style="width: 9%">
                 <asp:DropDownList runat="server" Width="102%" ID="ddlBranch" Height="26px"></asp:DropDownList>
