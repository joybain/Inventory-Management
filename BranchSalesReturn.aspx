<%@ Page Title="" Language="C#" MasterPageFile="~/BranchMasterPage.master" AutoEventWireup="true" CodeFile="BranchSalesReturn.aspx.cs" Inherits="BranchSalesReturn" %>
         ...
         <table style="width:100%;"><tr>
           ...
           Text='<%#Eval("qnty")%>' Width="93%" onFocus="this.select()"></asp:TextBox></ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="Barcode">
                             <ItemTemplate>
                                 <asp:TextBox ID="txtBarcode" runat="server" AutoPostBack="True" Font-Size="8pt" 
                                     MaxLength="15" onFocus="this.select()" SkinId="tbPlain" 
                                     Text='<%# Eval("Barcode") %>' Width="93%"></asp:TextBox>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
           ...
           <ContentTemplate>               
                         <table style="width: 100%" >
                             ...
                             <tr>
                                 ...
                                 <td style="width:30%; height: 27px;">
                                     <asp:TextBox ID="txtChequeDate" runat="server" Font-Size="8pt" SkinId="tbPlain" onkeypress="return isNumber(event)"
