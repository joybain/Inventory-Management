<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptScheduleOfCashatBank.aspx.cs" Inherits="rptScheduleOfCashatBank" %>
...
<tr style="width:100%;">
<td style="width:100%;">
<asp:Label ID="lblTitle" runat="server" Font-Size="Small" Height="15px" 
        Width="100%" style="font-size: medium"></asp:Label>
</td>
</tr>
</table>
</td>
...
CssClass="Grid"
  ...
  <asp:BoundField HeaderText="Account"  
      ...
      <asp:BoundField DataField="Openin" HeaderText="Previous Balance">

      <ItemStyle HorizontalAlign="Right" Width="150px" />
      </asp:BoundField>

      <asp:BoundField DataField="Period_amount" HeaderText="This Period" >

      <ItemStyle HorizontalAlign="Right" Width="150px" />
      </asp:BoundField>

  <asp:BoundField HeaderText="Total" ItemStyle-Width="150px" 
          DataField="Closing"  ItemStyle-HorizontalAlign="Left" > 
      <ItemStyle HorizontalAlign="Right" Width="150px" />
      </asp:BoundField>
  </Columns>
