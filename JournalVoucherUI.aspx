<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalVoucherUI.aspx.cs" Inherits="JournalVoucherUI" %>--%>

 <%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="JournalVoucherUI.aspx.cs" Inherits="JournalVoucherUI" Title="Journal Voucher.-DDP"  Theme="Themes" MaintainScrollPositionOnPostback="true"%>
...
<tr>
<td style="width:1%;">&nbsp;</td>
<td style="width: 98%; vertical-align: top; color: Maroon;"  align="left"><h2>>> Journal Voucher.</h2></td>
<td style="width:1%;">&nbsp;</td>
</tr>
<tr>
<td style="width:1%;"></td>
       ...
       <tr>
        ...
        <tr>
            ...
            <td style="width: 15%;">
                ...
                <asp:TextBox ID="txtVchSysNo0" runat="server" AutoPostBack="False" 
                    CssClass="tbc" Enabled="False" Font-Size="8pt" MaxLength="6" SkinID="tbGray" 
            ...
            <td style="width: 15%;" align="left">
                <asp:Label ID="LblValueDate1" runat="server" Font-Size="8pt" Width="100%" 
            ...
            <td align="left" style="width: 15%;">
                ...
                <ajaxToolkit:CalendarExtender ID="txtValueDate_CalendarExtender" 
                    runat="server" Format="dd/MM/yyyy" TargetControlID="txtValueDate" />
            </td>
            <td style="width: 15%;">
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            &nbsp;<td align="left" style="width: 15%;">
                &nbsp;</td>
            <td style="width: 15%;" align="left">
                <asp:Label ID="Label15" runat="server" Font-Size="8pt" Width="100%">Manual 
        ...
        <tr>
            ...
            <td style="width: 15%;">
                &nbsp;</td>
            <td style="width: 5%;" align="left" />
            <asp:Label ID="lblStatus" runat="server" Font-Size="8pt" Width="100%" 
                    ...
                    <table style="width: 250px;">
                        ...
                        <tr>
                            <td style="width: 150px">
                                <asp:Button ID="CancelBtn" runat="server" OnClientClick="HideModalDiv();" Font-Size="8pt" Text="Cancel" Width="60px" OnClick="CancelBtn_Click" />
                            </td>
                            <td style="width: 116px">
                                <asp:Button ID="LoginBtn" runat="server" OnClientClick="HideModalDiv();" Font-Size="8pt" Text="Authorize" OnClick="LoginBtn_Click" /></td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <fieldset style="vertical-align: top; border: solid 1px #8BB381; text-align:left;width: 50%">
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 60%">
                                <asp:TextBox ID="txtVoucher" runat="server" Width="100%" 
                                    CssClass="txtVisibleAlign" Height="20px" 
                                    Placeholder="Input Voucher No and click Find Button"></asp:TextBox>
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
