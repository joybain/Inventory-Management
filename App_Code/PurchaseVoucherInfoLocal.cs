...
/// </summary>
public class PurchaseVoucherInfoLocal
{
    public string ID
        ,GoodsReceiveNo
        ,GoodsReceiveDate
        ...
        ,ChequeDate
        ,ChequeAmount
        , Due, ShiftmentID, ShiftmentNO, ChkStatus, PartyID, AdvancePayFlag, BranchID;  
	public PurchaseVoucherInfoLocal()
	{
		//
    ...
    public PurchaseVoucherInfoLocal(DataRow dr)
    {
        ...
        if (dr["AdvancePayFlag"].ToString() != string.Empty) { this.AdvancePayFlag = dr["AdvancePayFlag"].ToString(); }
