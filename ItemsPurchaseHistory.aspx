<%@ Page Title="Purchase History.-RD" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ItemsPurchaseHistory.aspx.cs" Inherits="ItemsPurchaseHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td style="width:10%;">
                &nbsp;</td>
            <td style="width: 80%; height: 4px; vertical-align: top; font-size: 12pt; color: Maroon; font-weight: 800;"  align="left">
                    ...
                    <tr>
                        <td style="width:10%; height: 31px;" align="right">
                            <asp:Label ID="Label3" runat="server" style="font-weight: 700" 
                                Text="Search By Supplier"></asp:Label>
        <asp:HiddenField ID="hfSupplierID" runat="server" />
                        </td>
                        <td style="width:1%; height: 31px;">
                            </td>
        ...
        <asp:TextBox ID="txtSupplierSearch" runat="server" AutoPostBack="True" CssClass="txtVisibleAlign"
            ...
            Width="99%" Font-Bold="True" Height="18px"></asp:TextBox>
        <ajaxToolkit:AutoCompleteExtender ID="txtSupplierSearch_AutoCompleteExtender" runat="server" 
           ...
           <ContentTemplate> 
    <asp:TextBox SkinId="tbPlain" ID="txtStartDateDate" runat="server" Width="100%" 
                                style="text-align:center;" PlaceHolder="dd/MM/yyyy"
            CssClass="tbc"  AutoPostBack="True"  Font-Size="8pt" ontextchanged="txtStartDateDate_TextChanged" 
                               ></asp:TextBox>
    <ajaxtoolkit:calendarextender runat="server" ID="Calendarextender1" 
            TargetControlID="txtStartDateDate" Format="dd/MM/yyyy"/>
                        ...
                        <td style="width:10%;" align="right">
                            <asp:Label ID="Label2" runat="server" style="font-weight: bold" Text="Date To"></asp:Label>
                        </td>
                        <td style="width:1%;">
                            &nbsp;</td>
                        <td style="width:10%;">
    ...
    <asp:TextBox SkinId="tbPlain" ID="txtEndDate" runat="server" Width="97%" 
                   style="text-align:center;" PlaceHolder="dd/MM/yyyy"
            CssClass="tbc"  AutoPostBack="True"  Font-Size="8pt" 
    ...
    <ajaxtoolkit:calendarextender runat="server" ID="txtEndDate_CalendarExtender" 
            TargetControlID="txtEndDate" Format="dd/MM/yyyy"/>
                        ...
                        <td style="width:10%;" align="center">
                            <asp:Button ID="btnRefresh" runat="server" Text="Clear" Width="70%" 
        ...
        <tr>
            ...
            <asp:GridView ID="dgDepartment" runat="server" 
                  ...
                  <Columns>
                      ...
                      <asp:TemplateField HeaderText="" ItemStyle-Width="40px">
                          <ItemTemplate>
                              <asp:Panel ID="panel1" runat="server">
                                 <a href="javascript:expandcollapse('div<%# Eval("GRN") %>', 'one');">
                                  <img id="imgdiv<%# Eval("GRN") %>" alt="Click to show/hide Maps"  width="25px"  src="img/plus.gif"/>
                                  </a>
                              </asp:Panel>
                          </ItemTemplate>
                          <EditItemTemplate>
                      ...
                      <asp:BoundField DataField="ReceivedDate" HeaderText="G.R. Date">
                      <ItemStyle HorizontalAlign="Center" Width="10%" />
                      </asp:BoundField>
                      <asp:BoundField DataField="ContactName" HeaderText="Supplier" >
                       ...
                       <asp:TemplateField>
                        <ItemTemplate>
                            <tr>
                                ...
                                <div id="div<%# Eval("GRN") %>" style="display:none; position:relative; OVERFLOW:auto;" >
